...
<!-- ADDED BY KERSTYN - poster and category info -->
	...
	<div class="discuss-admin-row postPage">
	<!-- postPage class added by Kerstyn-->
		<div class="row-fluid">
			<div class="pull-left">
			...
			<!-- MODIFIED BY KERSTYN - hide quote button
				<div class="pull-right">
		...
		<!-- MODIFIED BY KERSTYN - hide the user details
		<div class="pl-10">
	...
	<div class="discuss-item-right postPage">
	<!-- postPage class added by Kerstyn -->
