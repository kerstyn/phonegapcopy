...
<div class="discuss-entry">
	...
	<div class="row-fluid">
		<div class="pull-right mb-15">
			<!-- MODIFIED BY KERSTYN - hide replies button
	...
	<!-- MODIFIED BY KERSTYN - moved from line 106 to be below the question -->
	<div class="row-fluid">
		<div class="pull-right mb-15">
			<a href="#respond" class="btn btn-mini btn-success"><i class="icon-plus-sign"></i> <?php echo JText::_( 'COM_EASYDISCUSS_ADD_A_REPLY' );?></a>
			<!-- MODIFIED BY KERSTYN - hide replies button
	...
	<?php if( !$post->isProtected()  || DiscussHelper::isModerator( $post->category_id ) ){ ?>
		<div class="discuss-replies">
			...
			<a name="replies"></a>
			<div class="discuss-component-title"><?php echo JText::_('COM_EASYDISCUSS_ENTRY_RESPONSES'); ?>
			<!-- removed by Kerstyn (<span class="replyCount"><?php echo $totalReplies;?></span>)--></div>
